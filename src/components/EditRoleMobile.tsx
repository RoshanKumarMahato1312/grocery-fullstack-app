  ...
  return (
    <div className='flex flex-col items-center min-h-screen p-6 w-full '>
      <motion.h1 
          ...
          className='text-3xl md:text-4xl font-extrabold text-blue-700 text-center mt-8'
          >
            Select Your Role
      </motion.h1>
      ...
      >
        <label htmlFor="mobile Number" className='text-gray-700 font-medium mb-2'>Enter Your Mobile Number</label>
        <input 
        type="tel" id='mobile' 
        className='w-64 md:w-80 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-800' placeholder='eg. 1234567890'
