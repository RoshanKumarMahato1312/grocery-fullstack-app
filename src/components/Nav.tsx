            ...
            >
              <div className='flex items-center gap-3 px-3 py-2 border-b border-gray-100'>
                ...
                <div className='flex flex-col'>
                  <div className='text-gray-800 font-semiboold'>{user.name}</div>
                 <div className='text-xs text-gray-500 capitalize'>{user.role}</div>
                </div>
              </div>

              <Link href={""} className='flex items-center gap-2 px-3 py-3 hover:bg-blue-50 rounded-lg text-gray-700 font-medium' onClick={()=>setOpen(false)}>
