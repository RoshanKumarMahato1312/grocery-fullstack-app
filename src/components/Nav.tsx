    ...
    <div className='w-[95%] fixed top-4 left-1/2 -translate-x-1/2 bg-linear-to-r from-blue-500 to-blue-700 rounded-2xl shadow-lg shadow-black/30 flex justify-between items-center h-20 px-4 md:px-8 z-50'>
      ...
      <div className='flex items-center gap-3 md:gap-6 relative'>
        ...
        <div className='hidden md:flex items-center gap-4'>
          <Link href={"/admin/add-grocery"} className='flex items-center gap-2 bg-white text-blue-700 font-semibold px-4 rounded-full hover:bg-blue-100 transition-all'><PlusCircle className='w-5 h-5'/> Add Grocery</Link>
