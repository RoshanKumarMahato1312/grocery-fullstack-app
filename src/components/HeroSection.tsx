...
function HeroSection() {
  const slides=[
    {
      id:1,
      icon:<Leaf  className="w-20 h-20 sm:w-28 sm:h-28 text-blue-400 drop-shadow-lg"/>,
      title:"Fresh Organic Groceries",
      subtitle: "Farm-fresh fruits, vegetables, and daily essentials delivered to you.",
      btnText: "Shop Now",
      bg:"https://plus.unsplash.com/premium_photo-1741466800939-491f777d8b20?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
    {
      id:2,
    ...
    },
    {
      ...
      btnText:"Get started",
      bg:"https://plus.unsplash.com/premium_photo-1663926032491-f1143d141d65?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
  ]
  ...
  return (
    <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
      <AnimatePresence mode='wait'>
       ...
       className='absolute inset-0 flex flex-col items-center justify-center gap-6 max-w-3xl mx-auto text-center'
       >
      ...
      className='bg-white text-blue-700 hover:bg-blue-100 px-8 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 flex items-center gap-2'>
